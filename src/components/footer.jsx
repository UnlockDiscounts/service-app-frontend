export default function MendoraFooter() {
    ...
    return (
        <>
            ...
            <footer className="bottom-0 left-0 w-full p-10 text-gray-500 flex flex-col sm:flex-row justify-between gap-4 sm:gap-0 bg-[#FFFBEE] text-sm sm:text-base shadow-inner z-50">
